...
namespace AssetManagement.Migrations
{
    ...
    [Migration("20250817183149_RemoveOATHAndComputerNameFromSimplifiedEquipment")]
    partial class RemoveOATHAndComputerNameFromSimplifiedEquipment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetManagement.Models.SimplifiedEquipment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SIM_Card_Number")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<DateTime?>("Warranty_End_Date")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("AssetManagement.Models.TechnologyConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ConfigurationNotes")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
                    ...
                    b.ToTable("TechnologyConfigurations");
                });
            ...
            modelBuilder.Entity("AssetManagement.Models.TechnologyConfiguration", b =>
                {
                    b.HasOne("AssetManagement.Models.Equipment", "Equipment")
                        .WithOne("TechnologyConfiguration")
                        .HasForeignKey("AssetManagement.Models.TechnologyConfiguration", "EquipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AssetManagement.Models.Equipment", b =>
                {
                    ...
                    b.Navigation("TechnologyConfiguration");
                });
